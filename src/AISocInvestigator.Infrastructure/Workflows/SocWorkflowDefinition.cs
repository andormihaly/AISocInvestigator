...
public sealed class SocWorkflowDefinition(IntakeExecutor intakeExecutor, InvestigatorMCPExecutor investigatorMCPExecutor, KnowledgeExecutor knowledgeExecutor) : WorkflowDefinition
{
    ...
    public override Workflow CreateWorkflow()
    {
        ...
        builder.WithOutputFrom(investigatorMCPExecutor, knowledgeExecutor);
